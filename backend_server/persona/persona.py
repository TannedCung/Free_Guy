...
class Persona:
    ...
    def plan(
        self, maze: Maze, personas: dict[str, Persona], new_day: Union[bool, str], retrieved: dict[str, Any]
    ) -> Optional[str]:
        """
    ...
    def move(
        self, maze: Maze, personas: dict[str, Persona], curr_tile: tuple[int, int], curr_time: datetime.datetime
    ) -> tuple[Any, Any, str]:
        """
        ...
        if not self.scratch.curr_time:
            ...
            self.scratch.curr_time.strftime("%A %B %d")  # type: ignore[union-attr]
