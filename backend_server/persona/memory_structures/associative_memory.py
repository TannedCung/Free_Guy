...
class ConceptNode:
  ...
  def __init__(self,
               node_id: str, node_count: int, type_count: int,
               node_type: str, depth: int,
               created: datetime.datetime,
               expiration: Optional[datetime.datetime],
               s: str, p: str, o: str,
               description: str, embedding_key: str,
               poignancy: float, keywords: set[str],
               filling: list[Any]) -> None:
...
class AssociativeMemory:
  ...
  def add_event(self, created: datetime.datetime,
                      expiration: Optional[datetime.datetime],
                      s: str, p: str, o: str,
                      description: str, keywords: set[str],
                      poignancy: float,
                      embedding_pair: tuple[str, list[float]],
                      filling: list[Any]) -> ConceptNode:
  ...
  def add_thought(self, created: datetime.datetime,
                        expiration: Optional[datetime.datetime],
                        s: str, p: str, o: str,
                        description: str, keywords: set[str],
                        poignancy: float,
  ...
  def add_chat(self, created: datetime.datetime,
                     expiration: Optional[datetime.datetime],
                     s: str, p: str, o: str,
                     description: str, keywords: set[str],
                     poignancy: float,
  ...
  def retrieve_relevant_thoughts(self,
                                  s_content: str,
                                  p_content: str,
                                  o_content: str) -> set[ConceptNode]:
  ...
  def retrieve_relevant_events(self,
                                s_content: str,
                                p_content: str,
                                o_content: str) -> set[ConceptNode]:
    contents = [s_content, p_content, o_content]
